...
Model`NameLaTeX ="U_{B-L} Dirac neutrino model";
Model`Authors = "D. Restrepo, O Zapata & J. Calle";
Model`Date = "2018-04-25";
...
LagNoHC = -(mu2 conj[H].H - L1 conj[H].H.conj[H].H + MuP conj[S].S - L2 conj[S].S.conj[S].S - L3 conj[S].S.conj[H].H);

LagHC = - (+ Yd H.d.q + Ye H.e.l + Yu conj[H].u.q + Yv conj[H].l.v );
